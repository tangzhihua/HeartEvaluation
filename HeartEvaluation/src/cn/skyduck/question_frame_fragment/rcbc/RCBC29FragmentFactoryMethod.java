...
public class RCBC29FragmentFactoryMethod implements IQuestionnaireFramePageFragmentFactoryMethod, Serializable {
	...
	public Fragment createQuestionnaireFramePageFragment(final Object dataSource) {
		...
		RCBC29Fragment fragment = new RCBC29Fragment();
