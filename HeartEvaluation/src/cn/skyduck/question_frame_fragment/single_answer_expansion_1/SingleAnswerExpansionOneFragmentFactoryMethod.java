...
public class SingleAnswerExpansionOneFragmentFactoryMethod implements IQuestionnaireFramePageFragmentFactoryMethod, Serializable {
	...
	public Fragment createQuestionnaireFramePageFragment(final Object dataSource) {
		...
		SingleAnswerExpansionOneFragment fragment = new SingleAnswerExpansionOneFragment();
