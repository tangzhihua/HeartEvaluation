package cn.skyduck.custom_control.textview_ellipse_end_fixed;
 ...
 */
// textview多行ellipsize="end"不显示省略号的解决方法
public class TextViewEllipseEndFixed extends TextView {
	...
	private static final boolean HAS_BUG = Integer.parseInt(android.os.Build.VERSION.SDK) < 14; // <4.0
	...
	public TextViewEllipseEndFixed(Context context, AttributeSet attrs, int defStyle) {
